  ...
  return (
    <main className=" w-full py-10 h-screen flex items-center justify-center">
      <form
        ...
        action=""
        className=" p-3 shadow-lg bg-gray-300 w-[500px] max-w-[500px] rounded-md"
      >
        <div className="mb-5">
          <img className="w-[200px] mx-auto" src={logo} alt="" />
          <h2 className=" text-center font-semibold text-2xl text-green-400 mt-3">
            Registration 
          </h2>
        </div>

        <div className=" mb-2">
          <label className=" text-sm text-green-400 font-medium" htmlFor="">
            Name
          </label>
          <input
            {...register("name", { required: "Name Must reqired" })}
            type="text"
            className=" mt-1 p-2 w-full bg-white border-2 border-green-400 rounded-md focus:border-green-500 active:border-green-500 outline-0"
            name="name"
            id="name"
        ...
        <button
          type="submit"
          className=" mb-2 p-3 bg-green-400 text-white text-center w-full rounded-md hover:bg-green-500"
        >
          Register
        </button>
      </form>
